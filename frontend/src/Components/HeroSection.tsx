  ...
  <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10">
    <div className="relative overflow-hidden rounded-xl border p-8 bg-gradient-to-br from-background via-background/95 to-muted">
      ...
      <div className="flex gap-4 mt-6 relative z-10">
        <Button
          size="lg"
          className="bg-gradient-to-r from-primary to-purple-600 hover:from-primary/90 hover:to-purple-600/90 transition-all duration-300 shadow-lg shadow-primary/20"
        >
          Browse Games
        </Button>
        <Button
